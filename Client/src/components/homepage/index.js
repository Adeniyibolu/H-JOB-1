        ...
        <div className="homepage">
            ...
            <div className="about">
                ...
                <span className="explore">
                    ...
                    <p><Link to="explore" smooth={true} duration={1000}>Explore Node Features</Link></p>
                </span>
            </div>
            ...
            {list?.map((n, i) => (
                <div className="list" id="explore" key={i}>
                    ...
                    <p className="button"> <NavLink to="/wallet">CLICK HERE</NavLink></p>
                </div>
            ))}
            ...
            <div className="faqs">
                ...
                {faqs?.map((q, i) => (
                    <div className="questions-and-answers" key={i} onClick={() => openAnswer(q.id)}>
